...
// в обратном порядке заменить на i--
...
// в обратном порядке заменить на j--
console.log('_________________________________________');
...
// в обратном порядке заменить на m--
console.log('_________________________________________');
...
// в обратном порядке заменить на u--
console.log('_________________________________________');
...
// в обратном порядке заменить на n--
console.log('_________________________________________');
...
// в обратном порядке заменить на k--
console.log('_________________________________________');
